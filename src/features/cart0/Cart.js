                              ...
                              <li key={product.id} className="flex py-6">
                                ...
                                <div className="ml-4 flex flex-1 flex-col">
                                  ...
                                  <div className="flex flex-1 items-end  justify-start text-sm">
                                    <button className='w-7 bg-red-500 rounded-full border-2 '><PlusCircleIcon/></button>
                                    <p className='font-bold mx-4'>
                                      {product.quantity}
                                    </p>
                                    <button className='w-7 bg-red-500 rounded-full border-2 '><MinusCircleIcon/></button>
